...
public class ValuePropositionEncounter : MonoBehaviour {
    ...
    void OnEnable() {
        ...
        if(_animatorController != null) {
            ...
            if(_sprite.GetComponent<Animator>() != null) {
    ...
    void Update() {
        if(_canvas.activeInHierarchy) {
            if(Keyboard.current.spaceKey.wasReleasedThisFrame || Keyboard.current.enterKey.wasReleasedThisFrame || Pointer.current.press.wasPressedThisFrame) {
